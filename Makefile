...
# ------------------------------------------------------------------------------
live-preview: clean
	@echo "Starting Docker Compose Live Preview (rizwan-philosophy-liveserver)..."
	docker-compose up rizwan-philosophy-liveserver --force-recreate
...
# ------------------------------------------------------------------------------
deploy: clean
	@echo "Running Docker Compose Deployment (rizwan-philosophy-deploy)..."
	docker-compose up rizwan-philosophy-deploy --force-recreate
